...
<!-- Painel de ações -->
		...
		<ul class="nav nav-pills">
		  ...
		  <li class="dropdown">
				<div class="btn-group">
				  <button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-list-alt"></span> Relatório</button>
				  <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
				    <span class="caret"></span>
				    <span class="sr-only">Toggle Dropdown</span>
				  </button>
				  <ul class="dropdown-menu" role="menu">
				    <li><a href="#"><span class="glyphicon glyphicon-list-alt"></span> Action</a></li>
				    <li><a href="#"><span class="glyphicon glyphicon-list-alt"></span> Another action</a></li>
				    <li><a href="#"><span class="glyphicon glyphicon-list-alt"></span> Something else here</a></li>
				    <li class="divider"></li>
				    <li><a href="#"><span class="glyphicon glyphicon-list-alt"></span> Separated link</a></li>
				  </ul>
				</div>
		  </li>
		</ul>
  ...
  <div class="col-xs-6">
		 <form class="form-horizontal" role="form">
			  ...
			  <div class="form-group col-xs-10 col-sm-4">
			    ...
			    <input type="text" class="form-control" id="exampleInputPassword2" placeholder="descricão">
			  </div>
...
<div class="panel panel-default">
  ...
  <ul class="dropdown-menu" role="menu">
    ...
    <li><a href="#"><span class="glyphicon glyphicon-search"></span> Visualizar</a></li>
    <li><a href="#"><span class="glyphicon glyphicon-file"></span> Assentamento</a></li>
    <li><a href="#"><span class="glyphicon glyphicon-download-alt"></span> Exportar</a></li>    
  </ul>
  </div>
						</td>
						<td>Credit Card</td>
